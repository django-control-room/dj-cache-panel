...
This project is licensed under the MIT License. See the [LICENSE](https://github.com/django-control-room/dj-cache-panel/blob/main/LICENSE) file for details.

---

## Contributing

Want to contribute or set up the project for local development? See [Contributing](https://django-control-room.github.io/dj-cache-panel/contributing/) for prerequisites, Docker/virtualenv setup, running the example project, and the test suite. 
